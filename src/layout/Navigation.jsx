          ...
          <>
            <Link to="/home" className="d-flex aa-text-primary me-auto aa">
              <img
                src={logo}
                alt="logo"
                height={isPages ? (scrolled ? "50" : "150") : "50"}
                loading="lazy"
              />
              {isPages && (
                <p className={`aa-fs-p-4  mt-1 ms-3 ${scrolled ? "d-none" : ""}`}>
                  Adrian Albuera
                </p>
              )}
            </Link>
          ...
          <div className="offcanvas-body d-flex align-items-center justify-content-center">
            <ul className="navbar-nav text-center">
              <li className="nav-item my-2">
                <NavLink to="/home" className="aa-fs-p-1 nav-link">
                  Home
                </NavLink>
              </li>
              <li className="nav-item my-2">
                <NavLink to="/aboutme" className="aa-fs-p-1 nav-link">
                  About Me
                </NavLink>
              </li>
              <li className="nav-item my-2">
                <NavLink to="/projects" className="aa-fs-p-1 nav-link">
                  Projects
                </NavLink>
              </li>
              <li className="nav-item my-2">
                <NavLink to="/contacts" className="aa-fs-p-1 nav-link" >
                  Contacts
                </NavLink>
              </li>
            </ul>
