...
import adrian from "../assets/image/adrian.jpg";
...
export default function AboutMe() {
  ...
  return (
    <Layout>
      {/* === About Me === */}
      <section className="aa-bg-white" id="aboutMe">
        ...
        <div className="row g-0 mx-3 mx-sm-4 mx-md-5 py-5">
          {/* === About Me === */}
          <div className="col-12 col-md-6 col-lg-4 pe-4 d-flex flex-column">
            <h1 className="aa-fs-header-2 ">
              About <span className="aa-text-accent">Me</span>
            </h1>
            <p className="aa-fs-p-3">
              Delivering unique designs that stand out & make a difference
            </p>
            ...
            <a
              ...
              <Link
                href="/contact"
                className="aa-btn px-0 mt-2 text-center text-md-start"
            ...
            <div className="col-12 col-lg-4 px-0 py-2 d-none d-md-block d-lg-none">
              <img
                src={adrian}
                alt="Adrain"
                height={"500px"}
            ...
            <div className="mt-auto aa-fs-p-5 d-grid my-3">
          ...
          {/* Image */}
          <div className="col-12 col-lg-4 px-0 px-md-2 d-block  d-md-none d-lg-block">
            <img
              src={adrian}
              alt="Adrain"
              height={"500px"}
          ...
          <div className="col-12 col-md-6 col-lg-4 ps-0 ps-md-4 d-flex flex-column">
            <p className="aa-fs-p-4 mt-3 mt-md-0">
              With a background in crafting websites and mobile apps design and
              development for real people, I focus on building clean,
              user-centered experiences that feel intuitive and impactful. My
              design philosophy? Clarity over clutter, function over flash, and
              always designing with the end user in mind.
            </p>
            <div className="mt-auto">
              {Services.map((items, index) => (
                <span
                  className="aa-fs-p-5 aa-services-box me-2 my-1"
                  key={index}
                >
                  {items.service}
                </span>
      ...
      <section className="" id="info">
        <div className="row g-0 mx-3 mx-sm-4 mx-md-5 py-5">
          <div className="col-8">
            <p className="aa-fs-p-4">
              Hi, I’m Adrian Albuera, a Design Specialist with over 2+ years of
              experience transforming concepts into captivating visuals. My
              expertise spans across branding, web design, UX/UI design, and
              digital marketing, driven by a passion for creating impactful and
              memorable designs.
            </p>
          </div>
          <hr className="w-50 border-3 my-3" />
          <p className="aa-fs-p-4">Professional Design Software I use</p>
      ...
      {/* === FAQ === */}
      <section className="aa-bg-white rounded-bottom-5" id="faq">
        <div className="row g-0 mx-3 mx-sm-4 mx-md-5 py-5">
          <h1 className="aa-fs-header-2">Frequently Asked Questions</h1>
          <div className="accordion">
            {FAQ.map((items, index) => (
              <div key={index} className="accordion-item">
                ...
                {activeIndex === index && (
                  <div className="accordion-content">{items.content}</div>
                )}
              </div>
            ))}
          </div>
