...
import adrian_albuera from "../assets/image/adrian_albuera.png";
  ...
  return (
    <Layout>
      ...
      <section className="" id="aboutMe">
        <div className="row g-0 mx-3 mx-sm-4 mx-md-5 my-5">
          {/* === About Me === */}
          <div className="col-lg-4 pe-2">
            <div className="text-center text-sm-start">
              <h1 className="aa-fs-header-1 fw-normal ">
      ...
      <section className="aa-bg-white rounded-5" id="projects">
        <div className="row g-0 mx-3 mx-sm-4 mx-md-5 py-5 align-items-center">
          <div className="col-lg-8">
        ...
        <div className="row g-0 mx-3 mx-sm-4 mx-md-5 my-5">
          {Projects.slice(0, 6).map((items, index) => (
            <ProjectCard
              key={index}
              image={items.image}
              title={items.title}
